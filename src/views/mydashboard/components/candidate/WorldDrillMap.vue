...
export default{
    ...
    methods: {
        ...
        showDrillMap(){
            ...
            // TODO:Create series for background fill
            // https://www.amcharts.com/docs/v5/charts/map-chart/map-polygon-series/#Background_polygon
            var backgroundSeries = chart.series.push(am5map.MapPolygonSeries.new(root, {}));
            backgroundSeries.mapPolygons.template.setAll({
                fill: root.interfaceColors.get("alternativeBackground"),
            ...
            // Add background polygon 加上这个会有背景色，但是窗口大小改变了.. 749x400
            // https://www.amcharts.com/docs/v5/charts/map-chart/map-polygon-series/#Background_polygon
            // backgroundSeries.data.push({
            //     geometry: am5map.getGeoRectangle(374.5, 200, -374.5, -200)
            // });
            ...
            // Add button to go back to continents view 返回整体地图
            var backContainer = chart.children.push(am5.Container.new(root, {
                    ...
                    background: am5.RoundedRectangle.new(root, {
                        fill: am5.color(0xffffff), //#E5E5E5
                        fillOpacity: 0.2
                    }),
                    visible: false
                }));
